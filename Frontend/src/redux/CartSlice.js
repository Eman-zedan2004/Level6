...
const initialState = {
  selectedProducts: localStorage.getItem("selectProduct")
    ? JSON.parse(localStorage.getItem("selectProduct"))
    : [],
  selectedProductsID: localStorage.getItem("selectProductID")
    ? JSON.parse(localStorage.getItem("selectProductID"))
    : [],
};
